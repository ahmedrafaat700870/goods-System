     ...
     ?>
        ...
        <div class="mainDiv">
                <div class="cardStyle">
                    ...
                    <div class="inputDiv">
                    <label class="inputLabel" for="confirmPassword">Enter new phone</label>
                    <input class="phone-change" type="text" id="confirmPassword"  name="ChangePhone1" required="required">
                    </div>
